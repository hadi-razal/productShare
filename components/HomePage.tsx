  ...
  return (
    <>
      <Head>
        ...
        <title>Product Share | #1 Catalog Builder in India | Boost Your Business</title>
        <meta 
          name="description" 
        ...
        <meta property="og:title" content="Product Share - Revolutionary Catalog Builder" />
        <meta 
        ...
        <meta name="twitter:title" content="Product Share - Catalog Builder for Indian Businesses" />
        <meta 
      ...
      <main className="bg-gray-50">
          ...
          <div className="max-w-6xl mx-auto px-6 py-20 grid md:grid-cols-2 items-center gap-12">
            <div>
              <h1 className="text-5xl font-bold mb-6 text-white">
                India's <span className="text-blue-300">Smartest</span> Catalog Builder
              </h1>
        ...
        <section className="py-20 bg-white px-6">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-4xl font-bold text-center mb-12 text-gray-800">
              Designed for <span className="text-blue-600">Indian Businesses</span>
            </h2>
              ...
              {[
                {
                  ...
                  description: "Build professional catalogs in minutes with local language support",
                },
                {
                  icon: <Globe className="w-8 h-8 text-green-500" />,
                  title: "Multi-Platform Sharing",
                  description: "WhatsApp, Telegram, and local social media integrations",
                },
                {
                  icon: <TrendingUp className="w-8 h-8 text-purple-500" />,
                  title: "Local Market Analytics",
                  description: "Insights tailored to Indian e-commerce and retail trends",
                },
                {
                  icon: <FaMobile className="w-8 h-8 text-orange-500" />,
                  title: "Mobile-First Design",
                  description: "Optimized for low-bandwidth and mobile-dominant markets",
                }
              ].map((feature, index) => (
                <div 
                  key={index} 
        ...
        <section className="py-20 bg-gray-100 px-6">
          <div className="max-w-6xl mx-auto text-center">
            <h2 className="text-4xl font-bold mb-6">Affordable for Every Indian Business</h2>
            <p className="text-xl text-gray-600 mb-12">
              Transparent pricing with no hidden costs – starting at just ₹499
            </p>
            <div className="grid md:grid-cols-2 gap-8">
              {[
                ...
                <div 
                  key={index} 
                  className={`
                    p-8 rounded-xl shadow-lg relative
                    ${plan.isMostPopular 
                ...
                >
                  ...
                  <div className="flex items-baseline mb-6">
                    ...
                    <span className="ml-2">
                      {plan.title === 'Growth Plan' ? 'per year' : 'per month'}
                    </span>
                  </div>
        ...
        <section className="py-20 bg-blue-50 px-6">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-4xl font-bold text-center mb-12">
              Success Stories from <span className="text-blue-600">Indian Entrepreneurs</span>
            </h2>
            <div className="grid md:grid-cols-2 gap-8">
              {[
                {
                  content: "Product Share helped me scale my local handicraft business across India!",
                  author: "Priya Sharma",
                  authorRole: "Handicraft Entrepreneur, Mumbai",
                  rating: 5
                },
                {
                  content: "As a small restaurant owner, this tool transformed my menu marketing strategy.",
                  author: "Rajesh Kumar",
