...
const Page = () => {
  return (
    <div className='mx-auto max-w-6xl py-24 px-3'>
      ...
      <p>
        Product Share aims to offer a smooth experience for all customers using our digital catalogue builder. Below are the terms of our cancellation policy, applicable to both our Starter and Pro plans:
      </p>
      <ul>
        <li><strong>Cancellation Window: </strong> Cancellation requests will be accepted only if made within 1-2 days of the purchase of either the Starter or Pro plan.</li>
        ...
        <li><strong>Subscription Cancellations:</strong> Both the Starter and Pro plans are billed monthly. However, if you wish to cancel or discontinue using the service before the end of your plan’s duration, we will not provide a refund for any unused period.</li>
