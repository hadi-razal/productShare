...
export const metadata: Metadata = {
  ...
  description:
    "Product Share India pricing policy: Free plan with 3 listings. Starter plan at ₹499 and Pro plan at ₹999. 14-day refund window. Read our full pricing terms.",
  keywords: ["Product Share pricing policy", "catalog builder payment terms India", "₹499 starter plan", "₹999 pro plan"],
  alternates: { canonical: "https://productshare.in/pricing-policy" },
  robots: { index: true, follow: true },
  openGraph: {
    title: "Pricing Policy — Product Share India",
    description: "Starter ₹499 or Pro ₹999 — 14-day refund window, no hidden fees.",
      ...
      <div className="space-y-8 text-left max-w-7xl mx-auto">
        ...
        <section>
          ...
          <p className="text-gray-600 mb-4">
            Choose the plan that best fits your catalog. A free plan is available, with paid Starter and Pro options for growing stores.
          </p>
          <ul className="list-disc pl-6 space-y-3 text-gray-600">
            ...
            <li>
              <strong className="text-gray-900">Starter Plan:</strong> <span className="font-semibold text-green-600">₹499 / month</span>. Up to 25 product listings, 5 prebuilt themes, customer behavior analytics, theme customization, priority support, custom alert banners, sales charts, product videos, performance graphs, AI insights, and bulk product editing.
            </li>
            <li>
              <strong className="text-gray-900">Pro Plan:</strong> <span className="font-semibold text-green-600">₹999 / month</span>. Up to 150 product listings, 12 prebuilt themes, advanced analytics, everything in the Starter plan, plus team access and bulk CSV/Excel upload.
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p className="text-gray-600">
            If you wish to change your plan (e.g., switching from Starter to Pro), please reach out to our support team for assistance. Any change in plans will require a new payment for the selected plan.
          </p>
        </section>
