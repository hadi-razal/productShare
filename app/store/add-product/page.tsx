...
const CreateProduct = () => {
    ...
    try {
      const uploadPromises = imageFiles.map(async (file) => {
        const storageRef = ref(
          storage,
          `products/${formattedDate}_${file.name}`
        );
  ...
  return (
    <div className="w-full max-w-3xl mx-auto px-3 pb-10 pt-7">
      <div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              onChange={handleInputChange}
              className="w-full px-3 py-2 min-h-20  border bg-gray-200 focus:outline-none rounded-md"
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-center pb-3">
              <input
                ...
                className="w-2/3 px-3 py-2 border focus:outline-none rounded-l-md bg-gray-200"
              />
              <button
                type="button"
                onClick={handleAddColor}
                className="text-sm w-1/3 font-medium px-3 py-3 text-white rounded-r-md bg-blue-950"
              >
                Add Color
              </button>
            </div>
          ...
          <div className="flex space-x-4">
            <div className="flex items-center">
              <input
                ...
                id="most-selling"
              />
              <label htmlFor="most-selling" className="ml-2">
                Most Selling
              </label>
            </div>
            <div className="flex items-center">
          ...
          <div className="pt-4">
            <button
              ...
              className={`w-full py-2 px-4 rounded-md text-white ${
                isUploading ? "bg-gray-400 cursor-not-allowed" : "bg-blue-950"
              }`}
              disabled={isUploading}
            >
